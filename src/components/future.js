...
const Future = () => (
  <div class="future">
      ...
      <div class="container">
        ...
        <p>BluBlock sources licensing deals for anyone that owns an NFT and enables the BluBlock community to participate in those royalties in a crypto native way.</p>
      </div>
  </div>
)
