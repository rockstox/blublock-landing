...
const Hero = () => (
  <hero class="hero">
      <div class="container">
        <Bg />        
        <div class="center">
            <h1>Reinventing media licensing with Web3</h1>
            <h6>BluBlock is a blend of media, engineering, and Web3 experts that are revolutionizing media licensing.</h6>
            <div class="cta-container">
                ...
                <span>or</span>
                <a href="https://uinxq3fcctl.typeform.com/to/ZX0wN7UA" target="_blank" class="btn btn-secondary">Apply for the DAO</a>
            </div>
        </div>
      </div>
  </hero>
